...
Data Provided by: Two GeoJSON files were acquired as shapefiles and then converted for (1) Cryptid sightings, which are from bfro.net, and (2) the North Carolina county shape file from nconemap.gov.
